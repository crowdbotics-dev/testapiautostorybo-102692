...
## Project Structure
    ...
    ├── testapiautostorybo_102692  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_102692`
...
2. Clone this repo and `cd testapiautostorybo_102692`
